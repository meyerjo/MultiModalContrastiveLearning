...
NORMALIZATION_PARAMS = {
    'RGB': {
        # 'mean': [0.63680322, 0.41672922, 0.49176632],
        # 'std':  [0.23658685, 0.20514219, 0.20909343]
        # RGB modality
        'mean': [0.5144914934810244, 0.5144914934810244, 0.5144914934810244],
        'std':  [0.1914194416900493, 0.1914194416900493, 0.1914194416900493]
    },
    'DEPTH': {
        'mean': [0.23409406, 0.23409406, 0.23409406],
        'std':  [0.05382231, 0.05382231, 0.05382231]
    },
}

class Transforms_SICK_RGBD(object):
    '''
